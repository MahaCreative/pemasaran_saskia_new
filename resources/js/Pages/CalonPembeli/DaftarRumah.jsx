...
export default function DaftarRumah({ rumahs, tipes }) {
    ...
    return (
        <GuestLayout judul={"Katalog Rumah"}>
                            ...
                            {filteredRumah.map((rumah) => (
                                ...
                                >
                                    ...
                                    <div className="p-5 space-y-2">
                                        <h3 className="capitalize text-xl font-semibold text-gray-800 capitalize">
                                            {rumah.nama_rumah}
                                        </h3>
                                        ...
                                        <div className="flex justify-between items-center mt-4">
                                            ...
                                            <Link
                                                ...
                                                className="bg-green-600 text-white text-sm px-4 py-2 rounded hover:bg-green-700 transition-all"
                                            >
                                                Detail Rumah
                                            </Link>
                                        </div>
